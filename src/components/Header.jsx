                ...
                <div className="header-utility-bar">
                    <div className="container utility-container">
                        ...
                        <div className="utility-right">
                            <a href="tel:1933" className="utility-btn manas-helpline-btn">
                                <i className="bi bi-telephone-fill"></i> MANAS Helpline: 1933
                            </a>
                            <a href="https://ncbmanas.gov.in/" target="_blank" rel="noopener noreferrer" className="utility-btn submit-tip-btn-top">
                ...
                <div className="header-main-branding">
                    <div className="container branding-container">
                        ...
                        <div className="branding-middle-logos">
                            ...
                            <div className="logo-card">
                                <img src="/Umang_Logo.png" alt="UMANG Logo" />
                            </div>
                        </div>
                        ...
                        <div className="branding-right">
                            <div className="top-utility-links">
                                ...
                                <button className="utility-text-link accessibility-link" onClick={toggleAccessibility}>
                                    <i className="bi bi-universal-access"></i> ACCESSIBILITY
                                </button>
                                <div className="v-divider-small"></div>
                                <div className={`search-toggle-wrapper ${isSearchOpen ? "open" : ""}`}>
                                    {isSearchOpen && (
                                        <div className="search-pill-overlay">
                                            <input type="text" placeholder="Search..." className="search-input-field-mini" autoFocus />
                                            <button className="mini-search-submit" aria-label="Submit Search">
                                                <i className="bi bi-search"></i>
                                            </button>
                                        </div>
                                    )}
                                    <button className="utility-text-link search-toggle-btn" onClick={() => setIsSearchOpen(!isSearchOpen)}>
                                        <i className={`bi ${isSearchOpen ? "bi-x-lg" : "bi-search"}`}></i> SEARCH
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container nav-container-flex">
                        ...
                        <nav className={`main-nav ${isMenuOpen ? "show-sidebar" : ""}`}>
                            ...
                            <div className="nav-links">
                                ...
                                <div className={`nav-dropdown-li nav-lang-dropdown ${isLangOpen ? "accordion-open" : ""}`}>
                                    <button className="nav-item border-0 bg-transparent text-uppercase" onClick={() => setIsLangOpen(!isLangOpen)}>
                                        <i className="bi bi-translate"></i> {language === "English" ? "ENGLISH" : "हिंदी"} <span className="dropdown-arrow">▾</span>
                                    </button>
                                    <div className="dropdown-menu">
                                        <button className="dropdown-item w-100 text-start border-0 bg-transparent" onClick={() => { setLanguage("English"); setIsLangOpen(false); }}>English</button>
                                        <button className="dropdown-item w-100 text-start border-0 bg-transparent" onClick={() => { setLanguage("Hindi"); setIsLangOpen(false); }}>हिंदी</button>
                                    </div>
                                </div>
                            </div>
                        </nav>
